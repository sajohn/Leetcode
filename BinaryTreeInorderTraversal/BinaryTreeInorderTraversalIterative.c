...
void inorderTraversalHelper(struct TreeNode* root, int** returnSize, int* ret,  struct TreeNode** stack , int* top)
{
...
int* inorderTraversal(struct TreeNode* root, int* returnSize)
{
    ...
    *top =-1;
    ...
    if(root!=NULL)  
        inorderTraversalHelper(root, &returnSize, ret, stack, top);
